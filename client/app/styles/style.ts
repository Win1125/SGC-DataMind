export const styles = {
  title: 'text-[25px] text-black dark:text-white font-[500] font-Poppins text-center py-2 pb-5',
  ...
  h5: 'text-center pt-4 font-Poppins text-[14px] text-black dark:text-white'
}